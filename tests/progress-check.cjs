...
const bounds=await page.evaluate(()=>({heading:[...document.querySelectorAll('.post-body h2')].find(el=>el.textContent==='Section 3').getBoundingClientRect().top,toolbar:document.querySelector('.article-tools').getBoundingClientRect().bottom}));
